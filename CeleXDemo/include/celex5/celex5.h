  ...
  public:
    ...
    enum CeleX5Mode {
        ...
        Event_Off_Pixel_Timestamp_Mode =
            0, // Using Event_Off_Pixel_Timestamp_Mode, Event_Address_Only_Mode is deprecated.
        Event_In_Pixel_Timestamp_Mode =
            1, // Using Event_In_Pixel_Timestamp_Mode, Event_Optical_Flow_Mode is deprecated.
        ...
        Multi_Read_Optical_Flow_Mode =
            6, // Using Multi_Read_Optical_Flow_Mode, Full_Optical_Flow_M_Mode  is deprecated.
    };
    ...
    void parseCeleXRawData(uint8_t *pData, uint32_t dataSize, std::time_t timestampEnd,
                           std::vector<IMURawData> imuData);

    /*
     * Enable/Disable the Create Image Frame module
     * If you just want to obtain (x,y,A,t) array (don't need frame data), you cound disable this function to imporve
     * performance.
     */
     ...
     * If you just want to event frame (don't need (x,y,A,t) stream), you cound disable this function to imporve
     * performance.
     */
