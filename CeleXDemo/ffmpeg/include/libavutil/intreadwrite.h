...
#ifndef AV_RB48
#define AV_RB48(x)                                                                                                     \
    (((uint64_t)((const uint8_t *)(x))[0] << 40) | ((uint64_t)((const uint8_t *)(x))[1] << 32) |                       \
     ((uint64_t)((const uint8_t *)(x))[2] << 24) | ((uint64_t)((const uint8_t *)(x))[3] << 16) |                       \
     ((uint64_t)((const uint8_t *)(x))[4] << 8) | (uint64_t)((const uint8_t *)(x))[5])
#endif
#ifndef AV_WB48
