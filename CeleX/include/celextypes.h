...
typedef struct EventData {
    uint16_t col;
    uint16_t row;
    uint16_t adc;     // Event_Off_Pixel_Timestamp_Mode: adc is 0; Event Intensity Mode: adc is "Intensity";
                      // Event_In_Pixel_Timestamp_Mode: adc is "Optical-flow T"
...
typedef enum PlaybackState { NoBinPlaying = 0, Playing, BinReadFinished, PlayFinished, Replay } PlaybackState;
