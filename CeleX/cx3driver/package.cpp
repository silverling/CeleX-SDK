...
CElement::CElement() { wdataLen = 0; }

CElement::~CElement() {}

uint8_t *CElement::begin() { return data; }
uint8_t *CElement::end() { return data + wdataLen; }
...
void CPackage::end(void) { m_emStatus = BUFFER_STATUS_FULL; }
...
int CPackage::size() { return m_uiOffset; }
