...
CeleDriver::CeleDriver(void) { m_pCypress = new Cypress; }
 ...
 */
bool CeleDriver::openUSB() { return m_pCypress->openUSB(); }
 ...
 */
bool CeleDriver::openStream() { return m_pCypress->openStream(); }
 ...
 */
void CeleDriver::closeUSB() { m_pCypress->closeUSB(); }
 ...
 */
void CeleDriver::closeStream() { m_pCypress->closeStream(); }
 ...
 */
bool CeleDriver::i2cSet(uint16_t reg, uint16_t value) { return m_pCypress->usbSet(CTRL_I2C_SET_REG, reg, value); }
 ...
 */
bool CeleDriver::i2cGet(uint16_t reg, uint16_t &value) { return m_pCypress->usbGet(CTRL_I2C_GET_REG, reg, value); }
 ...
 */
bool CeleDriver::mipiSet(uint16_t reg, uint16_t value) { return m_pCypress->usbSet(CTRL_MIPI_SET_REG, reg, value); }
 ...
 */
bool CeleDriver::mipiGet(uint16_t reg, uint16_t &value) { return m_pCypress->usbGet(CTRL_MIPI_GET_REG, reg, value); }
 ...
 */
bool CeleDriver::writeSerialNumber(std::string number) { return m_pCypress->writeSerialNumber(number); }
 ...
 */
std::string CeleDriver::getSerialNumber() { return m_pCypress->getSerialNumber(); }
 ...
 */
std::string CeleDriver::getFirmwareVersion() { return m_pCypress->getFirmwareVersion(); }
 ...
 */
std::string CeleDriver::getFirmwareDate() { return m_pCypress->getFirmwareDate(); }
 ...
 */
bool CeleDriver::getSensorData(uint8_t *pData, uint32_t &length, std::time_t &timestampEnd,
...
uint16_t CeleDriver::getALSValue() { return getALSValue(); }
