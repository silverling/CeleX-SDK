...
DataRecorder::DataRecorder() : m_bRecording(false), m_iTimeStampStart(0), m_uiPackageCount(0) {
#ifdef _WIN32
 ...
 */
bool DataRecorder::writeData(uint8_t *pData, uint32_t length, std::time_t time_stamp_end,
