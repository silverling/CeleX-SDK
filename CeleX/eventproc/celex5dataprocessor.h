...
class CeleX5DataProcessor {
  ...
  private:
    ...
    void parseEventDataFormat0(uint8_t *pData, int dataSize,
                               std::time_t timestampEnd); // Format0: 24-bit packet with ADC data (CSR_73=2'b00)
    void parseEventDataFormat1(uint8_t *pData, int dataSize,
                               std::time_t timestampEnd); // Format1: 28-bit packet with ADC data (CSR_73=2'b01)
    void parseEventDataFormat2(uint8_t *pData, int dataSize,
                               std::time_t timestampEnd); // Format2: 14-bit packet without ADC data (CSR_73=2'b10)
    //
