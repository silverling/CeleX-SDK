...
WireinCommand::WireinCommand(const std::string &name)
    : m_strName(name), m_iAddressH(-1), m_iAddressM(-1), m_iAddressL(-1), m_iValueH(-1), m_iValueM(-1), m_iValueL(-1),
      m_iValue(-1), m_iMinValue(0), m_iMaxValue(0) {}
 ...
 *  @return   :
 */
void WireinCommand::setMaxValue(int32_t value) { m_iMaxValue = value; }
 ...
 *  @return   :
 */
void WireinCommand::setMinValue(int32_t value) { m_iMinValue = value; }
